...
- Shifts can occur with: a smooth change in an internal process  _or_ a disturbance triggering a different system
...
<img src="images/bcgov-github-landing-2021.png" alt="bcgov GitHub web page screen shot from 2021" style="max-width:70%;"/>
...
.right-column[
<img src="images/cop-logo.png" alt="Picture of bcgov Data Science Community of Practice logo sticker" style="max-width:80%; padding: 0px 0px 0px 0px;"/>
]

.left-column[
<img src="https://git-scm.com/images/logo@2x.png" alt="Git logo" style="max-width:80%; padding: 75px 0px 0px 0px;"/>  

<img src="https://www.r-project.org/Rlogo.png" alt="R Project for Statistical Computing logo" style="max-width:60%; padding: 0px 0px 0px 0px;"/>  

<img src="https://www.python.org/static/img/python-logo@2x.png" alt="Python logo" style="max-width:120%; padding: 0px 0px 0px 20px;"/>
