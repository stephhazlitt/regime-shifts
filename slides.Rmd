...
## Current State: Building Community 
...
<img src="https://git-scm.com/images/logo@2x.png" alt="Git logo" style="max-width:12%; padding: 0px 15px 10px 100px;"/><img src="https://www.r-project.org/Rlogo.png" alt="R Project for Statistical Computing logo" style="max-width:8%; padding: 0px 15px 10px 0px;"/><img src="https://www.python.org/static/img/python-logo@2x.png" alt="Python logo" style="max-width:20%; padding: 00px 0px 0px 0px;"/>
