...
## Growth & Use of R in the BC Public Service 🇨🇦 
...
.Large.pull-left[
- Large changes in the structure and function of a system  
  
- Shifts can occur with: a smooth internal change in a process  _or_ an external  disturbance triggering a change
...
## Internal Change: Building Community

<hr>

.right-column[.center[
<img src="images/Rcourse2014.jpg" alt="Picture of BCPS first R training course" style="max-width:65%; padding: 0px 0px 0px 50px;"/>
]]

.left-column[
<img src="https://www.software.ac.uk/sites/default/files/The%20Carpentries.jpg" alt="The Carpentries logo" style="max-width:85%; padding: 20px 0px 0px 50px;"/><img src="https://scotttalks.info/user-http/img/green_short_hexsticker.png" alt="rOpenSci logo" style="max-width:90%; padding: 0px 0px 0px 130px;"/>
]
...
## External Disturbance: bcgov GitHub
...
.footnote[https://github.com/bcgov (2013)]
...
<img src="images/bcgov-github-ds-resources.png" alt="" style="max-width:70%;"/>
...
.pull-left[
<img src="images/slh-helpme-gist.png" alt="" style="max-width:150%; padding: 0px 0px 0px 0px;"/>
]

.pull-right[
<img src="images/code-together_Feb2020.jpeg" alt="" style="max-width:80%; padding: 150px 0px 0px 120px;"/>
]
...
## Internal Change: Still Building Community

<hr>

.right-column[
<img src="images/cop-logo.png" alt="Picture of bcgov Data Science Community of Practice logo sticker" style="max-width:60%; padding: 0px 0px 0px 0px;"/>

<img src="https://git-scm.com/images/logo@2x.png" alt="Git logo" style="max-width:15%; padding: 0px 0px 0px 0px;"/><img src="https://www.r-project.org/Rlogo.png" alt="R Project for Statistical Computing logo" style="max-width:10%; padding: 0px 0px 0px 0px;"/><img src="https://www.python.org/static/img/python-logo@2x.png" alt="Python logo" style="max-width:30%; padding: 0px 0px 0px 0px;"/>
]
...
.pull-left[
<img src="https://community.rstudio.com/uploads/default/original/3X/4/4/44b540951af86190ea817a3333ba114e335aed35.jpeg" alt="RStudio logo" style="max-width:30%; padding: 100px 0px 0px 0px;"/>
<img src="https://scotttalks.info/user-http/img/green_short_hexsticker.png" alt="rOpenSci logo" style="max-width:30%; padding: 0px 0px 0px 130px;"/>
]
...
<img src="images/env-shiny-example.png" alt="" style="max-width:40%; padding: 0px 50px 0px 0px;"/>
<img src="images/bcstats-shiny-example.png" alt="" style="max-width:45%; padding: 0px 0px 20px 0px;"/>
...
## Regime Shifts & R for Data Science
...
```{r, echo=FALSE, fig.width=5, fig.height=3, fig.alt=""}
df <- data.frame(y = c(1,2,1,2,3,3,3,3,1,1,5,5,5,8,8,8,7,9,9,8,9,10),
                 x = c(1:22))
df %>% 
  ggplot() +
  geom_line(aes(x,y), colour = "#440154FF", size = 4) +
  labs(x = NULL, y = NULL) +
  theme_minimal() +
  theme(axis.text = element_blank()) +
  annotate("segment", x = 22.2, xend = 22, y = 8.4, yend = 10,
           colour = "#440154FF", size = 4, lineend = "round") +
...
.Large[.pull-right[
<img src="images/matthew-bargh-sXb-Yf7GGs8-unsplash.jpg" style="max-width:90%;  alt="Picture of Columbia-Shuswap Ecosystem, British Columbia, Canada" padding: 100px 100px 0px 0px;"/>
 ]]
