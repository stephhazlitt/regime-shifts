...
.right-column[.center[
<img src="images/Rcourse2014.jpg" alt="Picture of BCPS first in-house R training course" style="max-width:65%; padding: 0px 0px 0px 50px;"/>
]]

.left-column[
<img src="https://www.software.ac.uk/sites/default/files/The%20Carpentries.jpg" alt="The Carpentries hexagon-shaped logo" style="max-width:85%; padding: 20px 0px 0px 50px;"/><img src="https://scotttalks.info/user-http/img/green_short_hexsticker.png" alt="rOpenSci hexagon-shaped logo" style="max-width:90%; padding: 0px 0px 0px 130px;"/>
]
...
## Observation: It is About People
...
.pull-right[
<img src="images/matthew-bargh-sXb-Yf7GGs8-unsplash.jpg" style="max-width:85%;" alt="Picture of Columbia-Shuswap Ecosystem, British Columbia, Canada"/>
